...
export const communityFeatures = [
  ...
  },
  {
    title: "修了後は任意の別サービス",
    description:
      "修了後の有料オンラインコミュニティは、希望者のみが任意で参加できる別料金のサービスです。スクールの延長ではありません。",
  },
] as const;
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "有料スクールとしての役務提供は2か月以内に終了します。受講修了後、希望者のみ任意で参加できる別料金のオンラインコミュニティがありますが、参加は必須ではありません。スクールの延長や継続コースではありません。",
  },
] as const;
