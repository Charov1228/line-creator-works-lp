...
export const testimonials = [
  {
    ...
    role: "編集経験あり",
    comment:
      "ほとんど独学でここまできていたので、「なんかわからんけどそういうもん」でやってたことをちゃんと理由付きで学べて楽しいです。",
  },
  {
    name: "受講生Bさん",
    role: "未経験",
    comment:
      "単純に操作方法を学ぶだけではなく、クリエイターとしての考え方を学べる教材になっていると感じました。",
  },
  {
    name: "受講生Cさん",
    role: "未経験",
    comment:
      "教材を確認できる専用サイトはとても操作しやすく、細かい不明点も補足記事で確認できるので、分かりやすく丁寧でした。",
  },
] as const;
...
export const differences = [
  {
    title: "学んで終わりにしない",
    description:
      "一般的なスクールはカリキュラム修了で卒業。私たちは動画編集会社として案件を受注しており、卒業後は当社基準を満たした方へのコミュニティ招待などを通じて、実際の仕事につながる環境を目指します。",
...
export const communityFeatures = [
  {
    title: "受講生コミュニティ",
    description:
      "受講期間中、同期の受講生と進捗共有や情報交換ができます。",
  },
  {
    title: "案件情報の共有",
    description:
      "受講期間中、案件に関する情報共有の場があります。紹介・受注・収入を保証するものではありません。",
  },
  {
    title: "修了後は招待制の別サービス",
    description:
      "修了後の有料オンラインコミュニティは、当社の基準を満たした方へ招待する別料金のサービスです。スクールの延長ではありません。",
  },
] as const;
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "有料のLine Creator Worksは、役務提供期間を2か月以内として運営しています。教材提供、課題提出、フィードバック等は当該期間内に完了する設計です。",
  },
  {
    question: "必要な機材はありますか？",
    answer:
      "編集ソフトが動作するPCが必要です。Adobe Premiere Pro をご自身でご契約いただく必要があります。詳細な推奨スペックは公式LINE登録後にご案内します。",
  },
  {
    question: "卒業後もサポートはありますか？",
    answer:
      "有料スクールとしての役務提供は2か月以内に終了します。受講修了後、当社の基準を満たした方には別料金のオンラインコミュニティへ招待する場合があります。受講修了者全員が参加できるものではなく、スクールの延長や継続コースでもありません。",
  },
] as const;
